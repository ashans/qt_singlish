...
#include "ui_singlishmain.h"

SinglishMain::SinglishMain(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::SinglishMain)
{
    ui->setupUi(this);
    this->initializeWithChars();
}

SinglishMain::~SinglishMain()
{
    delete ui;
}

void SinglishMain::initializeWithChars(){
    ...
    specialConsonantsUni[4]=QString("ර්")+QString("\u200D"); specialConsonants[4]="R";
    specialConsonantsUni[5]=QString("ර්")+QString("\u200D"); specialConsonants[5]="\\r";
    ...
    consonantsUni[25]="‍ය"; consonants[25]=QString("\\u005C") + QString("y");
...
void SinglishMain::updateSinhalaText(){
    QString s,r,v;
    QString text = ui->textSinglish->toPlainText();

    for (int i=0; i<specialConsonantCount; i++){
...
void SinglishMain::on_textSinglish_textChanged()
{
    ui->textSinhala->setPlainText(specialConsonantsUni[4]);
}
